...
class DiagnosingList extends StatefulWidget {
  const DiagnosingList({Key? key}) : super(key: key);

  @override
  State<DiagnosingList> createState() => _DiagnosingListState();
}

class _DiagnosingListState extends State<DiagnosingList> {
  bool _loading = true;
